...
\DoxyCodeLine{767                     + \mbox{\hyperlink{classstr}{str}}(type(exception))}
\DoxyCodeLine{768                 )}
...
\DoxyCodeLine{642             \textcolor{keywordflow}{or} type(device) == Device  \textcolor{comment}{\# pylint: disable=unidiomatic-\/typecheck}}
...
\DoxyCodeLine{338                 type(new\_dev)  \textcolor{comment}{\# pylint: disable=unidiomatic-\/typecheck}}
